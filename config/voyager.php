...
return [
    ...
    */
    ...
    'controllers' => [
        ...
        // 'namespace' => 'App\\Http\\Controller\\Voyager',
    ],
    ...
    */
    ...
    'database' => [
        'tables' => [
            'hidden' => ['translations','user_roles','permissions','roles','menus','migrations', 'data_rows', 'data_types', 'menu_items', 'password_resets', 'permission_role', 'settings'],
        ],
    ],
