                        ...
                        <div id="carousel-thumb" class="carousel slide carousel-fade carousel-thumbnails mb-5 pb-4" data-ride="carousel">
                            ...
                            <div class="carousel-inner text-center text-md-left" role="listbox">
                                <div class="carousel-item active">
                                    <img src="/storage/Photos/Horizontal/E-commerce/Products/1.jpg" alt="First slide" class="img-fluid">
                                </div>
                                <div class="carousel-item">
                                    <img src="/storage/Photos/Horizontal/E-commerce/Products/2.jpg" alt="Second slide" class="img-fluid">
                                </div>
                                <div class="carousel-item">
                                    <img src="/storage/Photos/Horizontal/E-commerce/Products/20.jpg" alt="Third slide" class="img-fluid">
                                </div>
                            </div>
                            <!--/.Slides-->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="mdb-lightbox no-margin">
                                ...
                                <figure class="col-md-4">
                                    <!--Large image-->
                                    <a href="/storage/Photos/Horizontal/E-commerce/Products/1.jpg" data-size="1600x1067">
                                        <!-- Thumbnail-->
                                ...
                                <figure class="col-md-4">
                                    <!--Large image-->
                                    <a href="/storage/Photos/Horizontal/E-commerce/Products/2.jpg" data-size="1600x1067">
                                        <!-- Thumbnail-->
                                        <img src="/storage/Photos/Horizontal/E-commerce/Products/2.jpg" class="img-fluid">
                                    </a>
                                </figure>
                                <!--Grid column-->
                                ...
                                <figure class="col-md-4">
                                    <!--Large image-->
                                    <a href="/storage/Photos/Horizontal/E-commerce/Products/20.jpg" data-size="1600x1067">
                                        <!-- Thumbnail-->
                                        <img src="/storage/Photos/Horizontal/E-commerce/Products/20.jpg" class="img-fluid">
                                    </a>
                                </figure>
                                <!--Grid column-->
                            </div>
        ...
        <div class="comments-list text-center text-md-left">
            ...
            <div class="row mb-5">
                ...
                <div class="col-sm-2 col-12 mb-3">
                    <img src="/storage/Photos/Avatars/img%20(8).jpg" alt="sample image" class="avatar rounded-circle z-depth-1-half">
                </div>
                <!--/.Image column-->
            ...
            <div class="row mb-5">
                <!--Image column-->
                <div class="col-sm-2 col-12 mb-3">
                    <img src="/storage/Photos/Avatars/img%20(30).jpg" alt="sample image" class="avatar rounded-circle z-depth-1-half">
                </div>
                <!--/.Image column-->
            ...
            <div class="row mb-5">
                <!--Image column-->
                <div class="col-sm-2 col-12 mb-3">
                    <img src="/storage/Photos/Avatars/img%20(28).jpg" alt="sample image" class="avatar rounded-circle z-depth-1-half">
                </div>
                <!--/.Image column-->
                <!--Content column-->
                <div class="col-sm-10 col-12">
