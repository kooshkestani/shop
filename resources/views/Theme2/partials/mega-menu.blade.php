...
<div class="container mt-5 pt-3">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark primary-color mt-5">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent1">
            ...
            <div class="aa-input-container" id="aa-input-container" style="background-color:transparent;">
                <input type="search" id="aa-search-input" class="aa-input-search" placeholder="Search Product" name="search" autocomplete="off" />
